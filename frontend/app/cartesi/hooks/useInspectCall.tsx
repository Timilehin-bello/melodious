...
// import { useNetwork } from 'thirdweb'; // Updated to use thirdweb
...
//   const { chainId, network } = useNetwork(); // Using useNetwork from thirdweb
...
//       if (!chainId) { // Adjusted to check thirdweb chainId
//         console.error("No active chain detected");
//         return;
//       }

//       let apiURL = "";

//       if (config[toHex(chainId)]?.inspectAPIURL) { // Adjusted to thirdweb chainId
//         apiURL = `${config[toHex(chainId)].inspectAPIURL}/inspect`;
//       } else {
//         console.error(`No inspect interface defined for chain ${toHex(chainId)}`);
//         return;
//       }
