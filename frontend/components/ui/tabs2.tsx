...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center rounded-lg bg-none text-md p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-md px-2 py-1  text-white text-md ring-offset-gray-200 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-[#950944] data-[state=active]:text-white data-[state=active]:shadow",
      className
    )}
    {...props}
  />
...
export { Tabs2, TabsList2, TabsTrigger2, TabsContent };
