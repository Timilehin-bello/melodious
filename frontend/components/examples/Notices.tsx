...
export const Notices: React.FC = () => {
  ...
  if (!data || !data.notices)
    return <p className="text-slate-400">No Notices</p>;
              ...
              {payloadIsJSON(n.payload) ? (
                JSON.parse(n.payload).type === "etherdeposit" ? (
                  ...
                  <Td color={"slategray"}>
                    ...
                    and id {JSON.parse(n.payload).content.token_id} transferred
                    to ctsi account {JSON.parse(n.payload).content.address}
                  </Td>
                ) : (
                  // Render something else for other JSON content
