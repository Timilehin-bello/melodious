...
import { localhostChain } from "../ConnectWallet";
          ...
          <TabPanels>
            <TabPanel>
              <Text fontSize="sm" color="slategray">
                Cartesi dApps recieve asset deposits via Portal smart contracts
                on the base layer.
              </Text>
              <br />
              <Accordion
                    ...
                    <Stack>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            if (!etherAmount)
                              return toast.error("Amount field required!");
                            setLoadEther(true);
                    ...
                    <Stack>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          const res: any = await withdrawErc721(
                            rollups,
                            provider,
                            erc721,
                            Number(erc721Id),
                ...
                <AccordionPanel>
                  <Stack>
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={async () => {
                        if(!erc1155 || !erc1155Id || !erc1155Amount) return toast.error("Fields required!")
                        setLoadERC1155(true)
                    ...
                    <Button
                      ...
                      onClick={ async () => 
                        {
                        try {
                        if(!erc1155 || !erc1155Ids || !erc1155Amounts) return toast.error("Fields required!")
            ...
            <TabPanel>
              <Accordion defaultIndex={[0]} allowMultiple>
                <Text fontSize="sm" color="slategrey">
                  After the withdraw request, the user has to execute a voucher
                  to transfer assets from Cartesi dApp to their account.
                </Text>
                <br />
                {!dappRelayedAddress && (
